...
var options = [soMax]option{
	...
	soQuickack:           {ianaProtocolTCP, sysTCP_QUICKACK, 0},
	soThinDupack:         {ianaProtocolTCP, sysTCP_THIN_DUPACK, 0},
	soThinLinearTimeouts: {ianaProtocolTCP, sysTCP_THIN_LINEAR_TIMEOUTS, 0},
}
...
var parsers = map[int64]func([]byte) (Option, error){
	...
	ianaProtocolTCP<<32 | sysTCP_QUICKACK:             parseQuickAck,
	ianaProtocolTCP<<32 | sysTCP_THIN_DUPACK:          parseThinDupAck,
	ianaProtocolTCP<<32 | sysTCP_THIN_LINEAR_TIMEOUTS: parseThinLinearTimeouts,
}
