...
// Level implements the Level method of opt.Option interface.
func (i *Info) Level() int { return options[soInfo].level }

// Name implements the Name method of opt.Option interface.
...
func parseCCInfo(b []byte) (opt.Option, error) { return &CCInfo{Raw: b}, nil }
...
func parseCCAlgorithm(b []byte) (opt.Option, error) { return CCAlgorithm(b), nil }
